...
bMotion_plugin_add_complex "knife_price" "%botnicks,?:? (price|cost|value) (of) (.+)" 100 bMotion_plugin_complex_knife_price "en"

proc bMotion_plugin_complex_knife_price { nick host handle channel text } {
  global botnicks
  if {[regexp -nocase "^${botnicks},?:? (price|cost|value) (of) (.+)" $text matches botn noparse details]} {
